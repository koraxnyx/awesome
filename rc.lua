...
awful.tag.add("", {
    ...
    -- Create the wibox and theming it
...
globalkeys = awful.util.table.join(
    ...
    --Para que el paso de ventanas sea como en i3
    ...
    awful.key({ modkey,           }, "d", function () awful.util.spawn_with_shell("dmenu_extended_run") end,
              {description = "dmenu", group = "dmenu"}),
    awful.key({ modkey,           }, "g", function () awful.util.spawn_with_shell("firefox") end,
              {description = "dmenu", group = "dmenu"}), 
    ...
    -- Aumenta y disminuye gaps al vuelo
...
awful.rules.rules = {
    ...
    -- Add titlebars to normal clients and dialogs - window decoration
...
client.connect_signal("manage", function (c)
    ...
    -- La manera de hacer redondas las esquinas son las 3 líneas siguientes 
    -- Solo funciona con Awesome 4.3 o superior
    -- El 6 es el radio de redondeo
    c.shape = function(cr,w,h)
	gears.shape.rounded_rect(cr,w,h,6)
    end
   
    -- Termina la función de redondear esquinas, empieza lo que había por defecto
...
--Autorun apps at the beginning

autorun = true
autorunApps =
{
   --Cargo compton para tener transparencias, etc
